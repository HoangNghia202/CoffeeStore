...
<html>
   ...
   <body>
       <%@include file="includes/navNoneLogin.jsp" %>
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="shop" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="login" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
